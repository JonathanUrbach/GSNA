...
#' In this way, the \code{Bai_CiHep_v_Fib2.de} and \code{Bai_CiKrt_v_Fib2.de} reaspectively were generated.
#'
...
#' \code{Bai_CiHep_dorothea_UP.Gsea} and \code{Bai_CiHep_dorothea_DN.Gsea} with \code{`FDR q-val` <= 0.05}.
#'
#' # Licensing
#'
...
#' Same data format as Bai_CiHep_DN.cerno, above.}
"Bai_CiKrt_DN.cerno"
...
#' Sanme data format as Bai_CiHep_dorothea_UP.Gsea.}
#'
