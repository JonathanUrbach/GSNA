...
#' hierarchical clustering. The default, \code{matrix_scaling_fun} argument, \code{\link{distMat2ScaledRank}()}
...
#' }
#'
#' @seealso \code{\link{gsnPareNetGenericToNearestNNeighbors}}, \code{\link{distMat2ScaledRank}}, \code{\link{gsnParedVsRawDistancePlot}}
#'
...
gsnPareNetGenericHierarchic <- function( object,
                                         ...
                                         cutoff = NULL,
                                         keepOrphans = TRUE,
                                         #N = 1,                                    # Degree for nodes. 1 should be fine for all hclust cases.
                                         matrix_scaling_fun = distMat2ScaledRank,  # Scaling function for matrix
