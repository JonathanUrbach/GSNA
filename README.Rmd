...
Installation of the **GSNA** package depends on other R packages, including the following:
...
We intend to make the **GSNA** package available on CRAN in the near future. If and when it is accepted by CRAN, you will be able to
